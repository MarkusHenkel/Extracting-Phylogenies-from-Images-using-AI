...
# TODO give better name ie transform_resize
def transform_1_ar(dataset):
    """
    Resizes images to 2048x2048 currently. TODO change to 1024x1024
    Image augmentation wrapper for dataset object's .set_transform() 
    ...
    # print(100 * "#")
    return dataset
# TODO give better name ie transform_dropout
def transform_2(dataset):
    """
    Augments images with dropout.
    Image augmentation wrapper for dataset object's .set_transform() 
...
def main():
    if __name__ == "__main__":
        ...
        test_augmentation(augment_1_ar, r"C:\Users\marku\Desktop\StudiumVault\Semester6\Bachelorarbeit\Code\Extracting-Phylogenies-from-Images-using-AI\data_collection\data142204405218\tree142204405218.jpg")
