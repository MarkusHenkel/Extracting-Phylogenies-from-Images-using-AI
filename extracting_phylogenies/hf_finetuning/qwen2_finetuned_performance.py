...
adapter_path = "/home/henkelm/qwen2-7b-instruct-trl-sft-newick_extraction_2/checkpoint-423"
...
# tuple = get_qwen2_output(model=model, sample=sample, processor=processor)
# print("expected:" + tuple[0])
# print("actual:" + tuple[1])

# load dataset
dataset_path = r"/home/henkelm/dataset_no_branchlengths/"
...
dir_path = "/home/henkelm/qwen2_finetuned_no_branchlengths/"
tsv_path = "/home/henkelm/qwen2_no_branchlengths.tsv"
...
for sample in dataset:
    ...
    generated_newick_path = os.path.join(dir_path, f"{id}", f"finetuned{id}.nwk")
